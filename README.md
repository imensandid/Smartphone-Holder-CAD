...
- **Tray inclination:** 30°–75°
- **Height adjustment:** 80–200 mm
- **Tray width:** 65–85 mm
- **Base footprint:** ≤ 120 × 120 mm
- **Nominal smartphone load:** 200 g
- **Safety factor:** FS ≥ 2
- **Total mass:** ≤ 400 g, excluding optional ballast
- **Angular locking** of the articulated arm
- **Drop resistance:** 200 g smartphone from 15 cm

## CAD & Manufacturing

The different components were designed and assembled using **SOLIDWORKS**, with technical drawings prepared for manufacturing.

The project combines several manufacturing processes:

- **3-axis CNC machining** using Mastercam
- **Sheet-metal design and fabrication**
- **FDM 3D printing** using Cura
